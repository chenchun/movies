...
var domIntro         = document.getElementById('ex-intro');
...
var physics = new ParticleSystem(0, 0, 0, restDrag); //raf.js
var started;
var mouseParticle;
var mouseThresh = 50;
...
$.getJSON('chrome500/movies-experiments.js', function(data) {
	console.log(data);
  experiments = data;
  loaded();
});

$.getJSON('chrome500/positions.js', function(data) {
	console.log(data);
  positions = data;
  loaded();
});

$.getJSON('chrome500/movies-tags.js', function(data) {
	console.log(data);
  tags = data;
...
//  });
  ...
  _.each(positions, function(p, i) {
	    var ep = new ExperimentParticle(experiments[i%experiments.length], p);
  });
